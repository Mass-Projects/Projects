...
namespace Version_Check
{
    public class PluginCheck
    {
        public static bool isUpdateAvailable()
        {
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~w~NAME Warning", "~y~Failed to check for a update", "Please check if you are ~o~online~w~, or try to reload the plugin.");
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~w~NAME Warning", "~y~A new Update is available!", "Current Version: ~r~" + curVersion + "~w~<br>New Version: ~o~" + receivedData);
            ...
            {
                Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~NAME", "", "Detected newest version of NAME.<br>Installed Version: ~g~" + curVersion + "");
                return false;
            }
        }
    }
